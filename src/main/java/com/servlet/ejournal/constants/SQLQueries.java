...
public interface SQLQueries {
    ...
    String UPDATE_USER =
            "update epam.user set email = ?," +
                    ...
                    " send_notification = ?" +
                    " where u_id = ?";
    String DELETE_USER = "delete from epam.user where u_id = ?";
    String FIND_TOPIC_BY_ID = "select * from epam.topic where t_id = ?";
    String DELETE_TOPIC = "delete from epam.topic where t_id = ?";
    ...
    String DELETE_COURSE = "delete from epam.course where c_id = ?";
    ...
    String DELETE_USER_COURSE = "delete from epam.user_course where u_c_id = ?";
    ...
    String FIND_TOPIC_COURSE_BY_T_ID_C_ID = "select * from epam.topic_course where t_id = ? and c_id = ?";
    String UPDATE_TOPIC_COURSE = "update epam.topic_course set t_id = ? where c_id = ?";
    String DELETE_TOPIC_COURSE = "delete from epam.topic_course where c_id = ?";
    ...
    String FIND_TEACHER_COURSE_BY_TCH_ID_C_ID = "select * from epam.teacher_course where tch_id = ? and c_id = ?";
    String UPDATE_TEACHER_COURSE = "update epam.teacher_course set tch_id = ? where c_id = ?";
    String DELETE_TEACHER_COURSE = "delete from epam.teacher_course where c_id = ?";
